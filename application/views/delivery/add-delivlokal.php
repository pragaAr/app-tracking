...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item">
          <a href="<?= base_url('pengirimanlokal') ?>" class="btn btn-dark float-right">
    ...
    <div class="section-body">
      <form action="<?= base_url('pengirimanlokal/proses') ?>" method="POST" id="form-tambah">
        <div class="row">
          <div class="col-lg-6">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-lg-6 col-md-6">
                    <label for="kddelivlokal">Kode Delivery</label>
                    <input type="text" name="kddelivlokal" id="kddelivlokal" class="form-control text-uppercase" value="<?= $kdkirim ?>" required readonly>
                  </div>
                  <div class="form-group col-lg-6 col-md-6">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-lg-12 col-md-12">
                    ...
                    <input type="text" name="status" id="status" class="form-control text-capitalize" value="paket disiapkan untuk dikirim ke alamat tujuan" required readonly>
                  </div>
...
<script src="<?= base_url('theme/assets/js/delivlokal.js') ?>"></script>
