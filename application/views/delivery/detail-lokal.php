    ...
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item">
          <a href="<?= base_url('pengirimanlokal') ?>" class="btn btn-dark">
      ...
      <div class="card">
        <div class="card-header">
          <p class="font-weight-bold">
            Kd Delivery : <span class="text-danger text-uppercase"><?= $deliv->kd_delivlokal ?></span>
          </p>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <p class="font-weight-bold">
                Cabang&emsp;&nbsp;&nbsp; : &nbsp; <?= strtoupper($deliv->nama_cab) ?>
              </p>
              <p class="font-weight-bold">
                  ...
                  <tr>
                    ...
                    if ($detail->sentAt === null) { ?>
                      <td>
                        ...
                        <i class="far fa-clock text-secondary ml-3" data-toggle="tooltip" title="Perjalanan ke Penerima"></i>
                      </td>
                    <?php } else { ?>
                      <td>
                        <?= ucwords($detail->status) ?>
                        <i class="fas fa-check text-success ml-3" data-toggle="tooltip" title="Sampai di Penerima"></i>
                      </td>
                    <?php } ?>
                  </tr>
                  <?php $no++ ?>
