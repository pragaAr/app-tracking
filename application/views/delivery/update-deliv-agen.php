...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item">
          <a href="<?= base_url('pengirimanagen') ?>" class="btn btn-dark mr-1">
    ...
    <div class="section-body">
      <form action="<?= base_url('pengirimanagen/prosesupdate') ?>" method="POST">
        <div class="row">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-lg-6 col-md-6">
                    ...
                    <input type="hidden" name="kddelivagen" class="form-control text-uppercase" value="<?= $deliv->kd_delivagen ?>" required readonly>
                  </div>
                  <div class="form-group col-lg-6 col-md-6">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-lg-5 col-md-5">
                    ...
                    <input type="hidden" name="status" id="status" class="form-control text-capitalize" value="paket disiapkan untuk dikirim ke pool - <?= $kota->nama_kota ?>" required readonly>
                  </div>
...
<script src="<?= base_url('theme/assets/js/update-delivagen.js') ?>"></script>
