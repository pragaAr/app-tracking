...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item">
          <a href="<?= base_url('pengirimancabang') ?>" class="btn btn-dark float-right">
    ...
    <div class="section-body">
      <form action="<?= base_url('pengirimancabang/proses') ?>" method="POST" id="form-tambah">
        <div class="row">
          <div class="col-lg-6">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-lg-6 col-md-6">
                    <label for="kddelivcab">Kode Delivery</label>
                    <input type="text" name="kddelivcab" id="kddelivcab" class="form-control text-uppercase" value="<?= $kdkirim ?>" required readonly>
                  </div>
                  <div class="form-group col-lg-6 col-md-6">
                ...
                <div class="form-row">
                  <div class="form-group col-lg col-md">
                    ...
                    <input type="text" name="platno" class="form-control text-uppercase" autofocus required oninvalid="this.setCustomValidity('Plat No wajib di isi!')" oninput="setCustomValidity('')">
                  </div>
                  <div class="form-group col-lg col-md">
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  <div class="form-group col-lg-12 col-md-12">
                    ...
                    <input type="text" name="status" id="status" class="form-control text-capitalize" value="paket disiapkan untuk dikirim ke cabang tujuan" required readonly>
                  </div>
                  <div class="form-group col-lg-8 col-md-8">
                    <label for="idpaket">No Reccu<span class="text-danger">*</span></label>
                    <select name="idpaket" id="idpaket" class="form-control select2" required oninvalid="this.setCustomValidity('Reccu wajib di isi!')" oninput="setCustomValidity('')">
...
<script src="<?= base_url('theme/assets/js/delivcab.js') ?>"></script>
