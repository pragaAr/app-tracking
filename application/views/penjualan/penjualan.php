     ...
     <div class="section-header">
       ...
       <div class="section-header-breadcrumb">
         <div class="breadcrumb-item">
           <a href="<?= base_url('penjualan') ?>" class="btn btn-primary" data-toggle="modal" data-target="#addPenjualan">
                 ...
                 <?php
                  ...
                  foreach ($penjualan as $data) : ?>
                   <tr>
                     ...
                     <?php if ($data->sentAtt == null) { ?>
                       <td class="text-center">
                         <div class="btn-group" role="group">
                           <a href="" class="btn btn-warning btn-sm btn-edit-penjualan" data-idpaket="<?= $data->id_paket ?>" data-toggle="tooltip" title="Edit">
                             <i class="fas fa-pencil-alt"></i>
                           </a>
                           <a href="<?= base_url('penjualan/detail/') . $data->reccu; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail">
                             <i class="fas fa-eye"></i>
                           </a>
                           <a href="<?= base_url('penjualan/delete/') . $data->reccu; ?>" class="btn btn-danger btn-sm btn-delete" data-toggle="tooltip" title="Delete">
 ...
 <form action="<?= base_url('penjualan') ?>" method="post">
   <div class="modal fade" id="addPenjualan" data-backdrop="static" role="dialog" aria-labelledby="addPenjualanLabel" aria-hidden="true">
     <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title font-weight-bold" id="addPenjualanLabel">Tambah Data Paket</h5>
         ...
         <div class="modal-body">
           ...
           <div class="form-row">
             <div class="form-group col-lg-3 col-md">
               ...
               <select name="kotaasal" class="form-control select2" required oninvalid="this.setCustomValidity('Kota asal wajib di isi!')" oninput="setCustomValidity('')">
                 <option value="" selected>Pilih Kota Asal</option>
                 <?php foreach ($kotaasal as $asal) : ?>
                   <option value="<?= $asal->id_kota ?>"><?= strtoupper($asal->nama_kota) ?></option>
                 <?php endforeach ?>
               </select>
             </div>
             <div class="form-group col-lg-3 col-md">
             ...
             <div class="form-group col-lg-3 col-md">
               <label class="font-weight-bold" for="cabasal">Cabang Asal<span class="text-danger">*</span></label>
               <select name="cabasal" class="form-control select2" required oninvalid="this.setCustomValidity('Kota tujuan wajib di isi!')" oninput="setCustomValidity('')">
                 <option value="" selected>Pilih Cab Asal</option>
                 <?php foreach ($cabasal as $cab) : ?>
 ...
 <form action="<?= base_url('penjualan/update') ?>" method="post">
   <div class="modal fade" id="editPenjualan" data-backdrop="static" role="dialog" aria-labelledby="editPenjualanLabel" aria-hidden="true">
     <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title" id="editPenjualanLabel">Edit Data Penjualan</h5>
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
             <span aria-hidden="true">&times;</span>
           </button>
         </div>
         <div class="modal-body">
           ...
           <div class="form-row">
             <div class="form-group col-lg-3 col-md">
               <label class="font-weight-bold" for="kotaasal">Kota Asal<span class="text-danger">*</span></label>
               <select name="kotaasal" class="form-control kotaasal select2" required oninvalid="this.setCustomValidity('Kota asal wajib di isi!')" oninput="setCustomValidity('')">
                 <option value="" selected>Pilih Kota Asal</option>
                 <?php foreach ($kotaasal as $asal) : ?>
                   <option value="<?= $asal->id_kota ?>"><?= strtoupper($asal->nama_kota) ?></option>
                 <?php endforeach ?>
             ...
             <div class="form-group col-lg-3 col-md">
               <label class="font-weight-bold" for="cabasal">Cabang Asal<span class="text-danger">*</span></label>
               <select name="cabasal" class="form-control cabasal select2" required oninvalid="this.setCustomValidity('Kota tujuan wajib di isi!')" oninput="setCustomValidity('')">
                 <option value="" selected>Pilih Cab Asal</option>
                 <?php foreach ($cabasal as $cab) : ?>
                   <option value="<?= $cab->id_cab ?>"><?= strtoupper($cab->nama_cab) ?></option>
                 <?php endforeach ?>
