     ...
     <div class="section-header">
       ...
       <div class="section-header-breadcrumb">
         <div class="breadcrumb-item">
           <a href="<?= base_url('penjualan') ?>" class="btn btn-primary" data-toggle="modal" data-target="#addPenlok">
                   ...
                   <tr>
                     ...
                     <td class="text-center">
                       <div class="btn-group" role="group">
                         <a href="" class="btn btn-warning btn-sm btn-edit-penlok" data-idpaket="<?= $data->id_paket ?>" data-toggle="tooltip" title="Edit">
                           <i class="fas fa-pencil-alt"></i>
                         </a>
                         <a href="<?= base_url('penjualanlokal/detail/') . $data->reccu; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail">
                           <i class="fas fa-eye"></i>
                         </a>
                         <a href="<?= base_url('penjualanlokal/delete/') . $data->reccu; ?>" class="btn btn-danger btn-sm btn-delete" data-toggle="tooltip" title="Delete">
 ...
 <!-- addPenlok -->
 <form action="<?= base_url('penjualanlokal') ?>" method="post">
   <div class="modal fade" id="addPenlok" data-backdrop="static" role="dialog" aria-labelledby="addPenlokLabel" aria-hidden="true">
     <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title font-weight-bold" id="addPenlokLabel">Tambah Data Paket</h5>
 ...
 <!-- editPenlok -->
 <form action="<?= base_url('penjualanlokal/update') ?>" method="post">
   <div class="modal fade" id="editPenlok" data-backdrop="static" role="dialog" aria-labelledby="editPenlokLabel" aria-hidden="true">
     <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title" id="editPenlokLabel">Edit Data Penjualan</h5>
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
             <span aria-hidden="true">&times;</span>
           </button>
         </div>
         <div class="modal-body">
           ...
           <div class="form-row">
             <div class="form-group col-lg-4 col-md">
               <label class="font-weight-bold" for="kotaasal">Kota Asal<span class="text-danger">*</span></label>
               <input type="hidden" class="form-control text-uppercase kotaasal" name="kotaasal" required readonly>
               <input type="text" class="form-control text-uppercase namakotaasal" name="namakotaasal" required readonly>
             </div>
             <div class="form-group col-lg-4 col-md">
               <label class="font-weight-bold" for="kotatujuan">Kota Tujuan<span class="text-danger">*</span></label>
