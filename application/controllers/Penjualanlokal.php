...
class Penjualanlokal extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['title']        = 'List Penjualan Lokal';
    ...
    $data['penjualan']    = $this->Penlok->getData();
  ...
  {
    $data['title']        = 'Detail Penjualan Lokal';
